...
import net.atcat.nanzhi.grave.com.item.graveStone;
...
public class blockReg {
  ...
  public static final Block graveBlock = registry.register( "grave", new graveBlock( ), ( Block block ) -> new graveStone( block, new Item.Properties( )
      .maxStackSize( 1 )
